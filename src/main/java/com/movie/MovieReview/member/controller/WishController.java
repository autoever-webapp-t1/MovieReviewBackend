...
public class WishController {
    ...
    public ResponseEntity<List<WishEntity>> getWishlistByMemberId(@PathVariable("memberId") Long memberId) {
        List<WishEntity> wishlist = wishService.getWishlistByMemberId(memberId);
